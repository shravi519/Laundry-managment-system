...
<div class="container" style="margin:20px;">
        <form method="post" action="">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input name="name" type="text" class="form-control" pattern="^[a-z,A-Z]+" id="inputEmail3" value="<?php echo $name; ?>" />
            </div>
          </div>
          <div class="row mb-3">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Phone No.</label>
            <div class="col-sm-10">
              <input name="phone" type="text" class="form-control" pattern="\d{10}" maxlength="10" value="<?php echo $phone; ?>"/>
            </div>
          </div>
          <div class="row mb-3">
