...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
    ...
    <h1 style="text-align:center;margin-top:100px;">You can view your Laundry status here</h1>
    <div class="container">
    <br/>
                        ...
                        <div class="col-12 col-md-10 col-lg-8">
                            <form class="card card-sm" action="" method="post">
                                <div class="card-body row no-gutters align-items-center">
                                    ...
                                    <!--end of col-->
                                    <div class="col-auto" style="margin-bottom:;">
...
if(isset($_POST['submit'])){
 ...
 $user_view=mysqli_query($link,"call get_user_view('$_POST[coupan]')");   //Stored procedure
    ...
    echo   "<div class='fields'><h4 class='attr'>Customer name:</h4><h1 class='val'>"; echo $row['name']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>No. of heavy clothes:</h4><h1 class='val'>"; echo $row['heavy']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>No. of delicate clothes:</h4><h1 class='val'>"; echo $row['delicate']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>No. of kids clothes:</h4><h1 class='val'>"; echo $row['kids']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>Other clothes:</h4><h1 class='val'>"; echo $row['other']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>Total amount:</h4><h1 class='val'>"; echo $row['t_amount']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>Laundry status:</h4><h1 class='val'>"; echo $row['L_status']; echo "</h1></div>";
    echo   "<div class='fields'><h4 class='attr'>Paid status:</h4><h1 class='val'>"; echo $row['P_status']; echo "</h1></div>";
    echo "</div>";
    }  
    }
