    ...
    <div class="container">
      <form method='post' action="" >
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="name" class="form-control" pattern="^[a-z,A-Z]+"  id="inputEmail3"  required />
          </div>
        </div>
  ...
  echo '<option>'.$row['name'] .'</option>';
    ...
    ?>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input name="phone" type="text" class="form-control" pattern="\d{10}" maxlength="10" required/>
          </div>
        </div>
